...
const MostPopulerProduct = () => {
    ...
    return (
        <div className=" md:col-span-6 row-span-2 h-[850px] md:h-[815px] card__shadow rounded-6px border-[1px] border-[#E3E8EF]">
            ...
            <button className="text-[14px] leading-20px font-popins text-[#2D5BFF] p-[20px] px-[40px]">
                Show more
            </button>
        </div>
    );
